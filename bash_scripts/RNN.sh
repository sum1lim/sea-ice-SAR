...
for i in {1..100}; do
    ...
    predict --ml-config ./Configs/ML_configs/NN_thk_regr/RNN/recursion.yml --result-dir ./results/NN_thk_regr/RNN/recursion_"$i" --checkpoint 1 --classes thk_"$i" --output-dir ./results/NN_thk_regr/RNN
    predict --ml-config ./Configs/ML_configs/NN_thk_regr/RNN/pred.yml --result-dir ./results/NN_thk_regr/RNN/recursion_"$i" --checkpoint 1 --classes thk_"$i" --output-dir ./results/NN_thk_regr/RNN
    ...
    predict --ml-config ./Configs/ML_configs/NN_rms_regr/RNN/recursion.yml --result-dir ./results/NN_rms_regr/RNN/recursion_"$i" --checkpoint 1 --classes rms_"$i" --output-dir ./results/NN_rms_regr/RNN
    predict --ml-config ./Configs/ML_configs/NN_rms_regr/RNN/pred.yml --result-dir ./results/NN_rms_regr/RNN/recursion_"$i" --checkpoint 1 --classes rms_"$i" --output-dir ./results/NN_rms_regr/RNN
done