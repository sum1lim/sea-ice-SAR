...
for file in backscatter_spk backscatter CAE_spk CAE mixed; do
...
boxplot --result-dir ./results/NN_type_class/ --model-type classification --methods backscatter_spk backscatter CAE_spk CAE mixed
...
for parent_dir in FYI_MYI; do 
    ...
    boxplot --result-dir ./results/NN_rms_regr/"$parent_dir" --model-type regression --methods backscatter_spk backscatter CAE_spk CAE mixed
done
...
for parent_dir in FYI_MYI; do 
    ...
    boxplot --result-dir ./results/NN_thk_regr/"$parent_dir" --model-type regression --methods backscatter_spk backscatter CAE_spk CAE mixed
done
